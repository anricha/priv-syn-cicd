...
export {
    ...
    IToggleTriggerResult,
    ILogger,
    IArtifactDeploymentResult,
    ISynapseClientException,
    IArtifactSource,
};
...
interface IArtifact {
    type: ArtifactType;
    json: string;
    data: unknown; //TODO: Determine real interface
    name: string;
}
...
interface ITriggerProperties {
    annotations: Record<string, unknown>[]; //TODO: Determine real interface
    pipelines: {
    ...
    typeProperties: {
        frequency: string;
        interval: number;
        schedule: Record<string, unknown>; //TODO: Determine real interface
        startTime: string; // TODO: Can this be cast as some kind of datetime object?
        timeZone: string;
    };
}
